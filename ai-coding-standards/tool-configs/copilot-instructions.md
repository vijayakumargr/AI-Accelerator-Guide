...
- Don't start responses with praise ("Great question!")
...
## When Uncertain
- When facing implementation complexity: **ASK for guidance**
- When uncertain about requirements: **CLARIFY explicitly**
- When discovering architectural flaws: **STOP and discuss**
